  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Conectores Disponíveis</h2>
          <p className="text-gray-600">Configure e monitore as integrações com sistemas externos</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {integrations.map((integration) => (
          <Card key={integration.id} className="card-hover bg-white border-0 shadow-soft">
            <CardHeader className="pb-4">
              <div className="flex items-start justify-between">
                ...
                <Badge className={`${getStatusColor(integration.status)} border font-medium`}>
