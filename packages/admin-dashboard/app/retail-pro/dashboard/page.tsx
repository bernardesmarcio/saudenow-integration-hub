        ...
        <div className="flex items-center justify-center h-64">
          <div className="text-center space-y-4">
            <div className="relative">
              ...
              <div
                className="absolute inset-0 w-16 h-16 border-4 border-transparent border-t-brand-300 rounded-full animate-spin mx-auto"
                style={{
          ...
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  <div
                    className={`status-dot ${systemHealth?.overall_status === "healthy" ? "healthy" : "error"}`}
                  />
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 rounded-lg bg-white/60 border border-gray-200/60">
                    ...
                    <Badge
                      className={`${getStatusColor(syncStatus?.status || "unknown")} px-3 py-1 font-medium`}
                    >
                      {syncStatus?.status === "completed"
                        ? "Concluído"
                        : syncStatus?.status || "Desconhecido"}
                    </Badge>
                  </div>
                  <div className="flex justify-between items-center p-3 rounded-lg bg-white/60 border border-gray-200/60">
                    <span className="font-medium text-gray-700">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="p-3 rounded-lg bg-white/60 border border-gray-200/60 text-center">
                      <p className="text-2xl font-bold text-gray-900">
                        {syncStatus?.stock_synced?.toLocaleString() || "0"}
                      </p>
                  ...
                  <div className="p-3 rounded-lg bg-white/60 border border-gray-200/60">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="font-bold text-gray-900">
                        {((metrics?.cache_hit_rate || 0.85) * 100).toFixed(1)}%
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${(metrics?.cache_hit_rate || 0.85) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-3 rounded-lg bg-white/60 border border-gray-200/60 text-center">
                      <p className="text-xl font-bold text-gray-900">
                        {metrics?.avg_response_time || 234}ms
                      </p>
                      <p className="text-xs text-gray-600">Tempo Médio</p>
                    </div>
                    <div className="p-3 rounded-lg bg-white/60 border border-gray-200/60 text-center">
                      <p
                        className={`text-xl font-bold ${(metrics?.error_rate || 0.02) > 0.05 ? "text-error-500" : "text-success-500"}`}
                      >
              ...
              Object.entries(systemHealth.components).map(
                ([component, status]) => (
                  <Card key={component}>
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        {"response_time" in status && (
                          <div className="flex justify-between">
                            <span>Tempo de Resposta:</span>
                            <span>{status.response_time}ms</span>
                          </div>
                        )}
                        {"active_jobs" in status && (
                          <div className="flex justify-between">
                  ...
                  <div>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${Math.min(((metrics?.avg_response_time || 0) / 1000) * 100, 100)}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${(metrics?.cache_hit_rate || 0) * 100}%`,
                        }}
                      ></div>
                    </div>
                  </div>
              ...
              <div className="space-y-2 max-h-96 overflow-y-auto">
                {logs.map((log, index) => (
                  ...
                  >
                    ...
                    <Badge
                      className={`${getLogLevelColor(log.level)} w-16 text-center`}
                    >
                      {log.level}
                    </Badge>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  ...
                  variant="outline"
                  onClick={() =>
                    window.open("/api/v1/retail-pro/health", "_blank")
                  }
                >
