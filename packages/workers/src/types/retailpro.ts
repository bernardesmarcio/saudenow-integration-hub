...
export const RETAIL_PRO_CACHE_KEYS = {
  ...
  STOCK: (store_sid: string, product_sid: string) => `retailpro:stock:${store_sid}:${product_sid}`,
...
export class RetailProTimeoutError extends RetailProError {
  constructor(store_sid?: string, product_sid?: string) {
    super('Timeout na requisição para Retail Pro', 'TIMEOUT', store_sid, product_sid)
