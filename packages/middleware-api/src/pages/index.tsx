        ...
        <div style={{
          ...
          <div style={{ 
            ...
            <div style={{
              ...
              <h3 style={{ color: '#2d3748', marginBottom: '0.5rem' }}>📚 API Docs</h3>
          ...
          <div style={{ 
            ...
            <h3 style={{ color: '#2b6cb0', marginBottom: '1rem' }}>🚀 Endpoints Disponíveis</h3>
            <div style={{ textAlign: 'left' as const }}>
              <div style={{ marginBottom: '0.5rem' }}>
                ...
                <span style={{ color: '#2d3748', fontSize: '0.9rem' }}>/api/v1/produtos</span>
              </div>
              <div style={{ marginBottom: '0.5rem' }}>
                <code style={{ 
                  background: '#2d3748', 
              ...
              <div style={{ marginBottom: '0.5rem' }}>
                ...
                <span style={{ color: '#2d3748', fontSize: '0.9rem' }}>/api/v1/produtos/[id]</span>
              </div>
              <div>
                <code style={{ 
                  background: '#2d3748', 
