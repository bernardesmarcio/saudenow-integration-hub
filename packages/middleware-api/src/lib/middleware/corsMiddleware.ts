...
export function validateJWT(req: NextApiRequest, res: NextApiResponse, next: () => void) {
...
export function optionalAuth(req: NextApiRequest, res: NextApiResponse, next: () => void) {
  const authorization = req.headers.authorization;
...
export function healthCheckBypass(req: NextApiRequest, res: NextApiResponse, next: () => void) {
