...
export type DevTableRow<T extends DevTableName> = Database['dev']['Tables'][T]['Row'];
export type DevTableInsert<T extends DevTableName> = Database['dev']['Tables'][T]['Insert'];
export type DevTableUpdate<T extends DevTableName> = Database['dev']['Tables'][T]['Update'];
...
export type PublicTableInsert<T extends PublicTableName> = Database['public']['Tables'][T]['Insert'];
export type PublicTableUpdate<T extends PublicTableName> = Database['public']['Tables'][T]['Update'];